...
import 'package:hc_management_app/features/check_out_sales/ui/list_product_page.dart';
...
class InputSOSalesPage extends StatefulWidget {
  const InputSOSalesPage({super.key});

  @override
  State<InputSOSalesPage> createState() => _InputSOSalesPageState();
}

class _InputSOSalesPageState extends State<InputSOSalesPage> {
